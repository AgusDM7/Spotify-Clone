...
interface Props {
  song: Song // La canción correspondiente a esta fila de la tabla
  isCurrentSong: boolean  // Si esta canción es la que se está reproduciendo actualmente
}


// Función auxiliar que determina si la canción pertenece a otra playlist distinta a la actual
